                        ...
                        <div className="tooltip">
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("MOE", TIME_ADDRESS)}>
                                        <p>MOE</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("WEED", MEMO_ADDRESS)}>
                                        <p>WEED</p>
                                    </div>
                                </div>
                            )}
